...
# 🎮 VanySlash — Community Edition

**Fast-paced slasher action in a self-contained standalone build.**
...
VanySlash is a fast-paced 2D hack-and-slash game featuring procedurally generated levels, pixel art visuals, and an original soundtrack. This Community Edition is a self-contained standalone build that includes all content released to date. No storefront or additional software is required — the game is ready to play immediately after installation.

This build is intended for players who want a self-contained, offline version of VanySlash without a storefront client.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2871010/ss_e11a7558744e9145952ca948cddb1458285b56bd.1920x1080.jpg?t=1786937508" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2871010/ss_54e94aef373e79f93dc219503e37cab7b40cb9c9.1920x1080.jpg?t=1786937508" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2871010/ss_c4538dda2f4400fd88d2c57da86a5d50143735db.1920x1080.jpg?t=1786937508" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, Russian, Portuguese-Brazil, Simplified Chinese
- **Voiceover:** English
...
- ⚔️ **Hack-and-Slash Combat** — Fast melee combat with combos, dodges, and finishers.
- 🎲 **Procedural Levels** — Every run generates new dungeon layouts, enemies, and loot.
- 🎨 **Pixel Art Visuals** — Hand-crafted pixel art with fluid character animations.
- 🎵 **Original Soundtrack** — Includes the full original score by the development team.
- 🕹️ **Gamepad Support** — Full controller support alongside keyboard and mouse.
- 🚀 **Ready to Play Immediately** — No activation steps — launch the game right after install.
- 🌍 **Multiple Languages** — Interface localized into several community-translated languages.
- 💾 **Compact Footprint** — Small install size with lossless compression and fast setup.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 / GeForce GTX 650 | GeForce GTX 1050 / Radeon RX 560 |
| **Storage** | 2 GB available space | 2 GB available space (SSD) |
| **Additional** | DirectX 11, keyboard and mouse | DirectX 11, gamepad recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\VanySlash\Saved`
